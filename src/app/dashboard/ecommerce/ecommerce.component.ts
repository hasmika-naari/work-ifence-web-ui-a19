...
@Component({
    ...
    standalone: true,
    imports: [WebsiteOverviewComponent, TopSellingProductsComponent, RevenueOverviewComponent, 
        VisitsByWeekComponent, OrderStatisticsComponent, SalesOverviewComponent, RecentOrdersComponent, 
        TransactionsHistoryComponent, SalesByLocationsComponent, EarningsReportsComponent, ButtonModule,
        MatButtonModule],
