...
@Component({
    ...
    standalone: true,
  imports: [RouterLink, RouterOutlet, RouterModule, NgxPaginationModule, NgOptimizedImage, HeaderWorkIfenceComponent, FooterWorkifenceComponent, CollegeJobsOpeningsComponent, CarouselModule, MatButtonModule, MatChipsModule, MatIconModule, MatMenuModule, MatCardModule, MatProgressBarModule],
