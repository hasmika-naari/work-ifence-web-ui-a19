...
import { CollegeJobItem, JobFeedItem } from '../../../services/ifence.model';
...
export class ActiveCollegeJobsComponent implements OnInit, OnDestroy {
    ...
    activeCollegeJobs : Signal<Array<CollegeJobItem>> = this.jobFeedStore.getCollegeJobsFeed();
