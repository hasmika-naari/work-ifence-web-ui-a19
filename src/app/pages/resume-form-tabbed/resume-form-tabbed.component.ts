...
@Component({
  selector: 'app-resume-form-tabbed',
  providers: [
    {
  ...
  templateUrl: './resume-form-tabbed.component.html',
  styleUrls: ['./resume-form-tabbed.component.scss']
})
export class ResumeFormTabbedComponent implements OnInit {
  ...
  constructor(private router : Router, public promptService : PromptService, 
      public genaiService : GenAIService, public templateService : TemplatesService) {}
